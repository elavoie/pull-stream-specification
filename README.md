...
The pull-stream design pattern defines a communication protocol between modules to propagate the values of a lazy stream, handles its termination, and handles failures during processing.
